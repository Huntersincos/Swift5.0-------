...
- (void)initCompareCallback
{
    sqlite3_create_function(_db, "compare_number", -1, SQLITE_ANY, NULL,
                            compare_number, NULL, NULL);
    sqlite3_create_function(_db, "compare_number_list", -1, SQLITE_ANY, NULL,
                            compare_number_list, NULL, NULL);
    sqlite3_create_function(_db, "compare_name", -1, SQLITE_ANY, NULL, compare_name, NULL, NULL);
}
